/**
 * Comprehensive skills organized by student domain/category
 * Based on Web Development, App Development, and AI/ML categories
 */
...
export function getSkillsForCategory(category: string | undefined): string[] {
  ...
  for (const [key, skills] of Object.entries(SKILLS_BY_CATEGORY)) {
